...
arenas. The 15-section 00-Unit envelope, restore, manifest, diff, and health gain
no aggregate-only format. Source changes still report all 18 invalidation fields
...
field use, checks all 18 invalidation fields against the 00-Unit diff, and then
