...
| Borrow-vs-move rules | ⚠️ | 📖 V4 — borrowed-parameter move blocking plus first-pass non-lexical explicit-loan rewrite and owned-move conflicts, including call arguments and all-path CFG repair proof for partial moves, exist; full region inference still expands |
