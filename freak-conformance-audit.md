...
- §4 borrow checker: registered V4 contract-region smokes cover repeated-source named/elided sets, iterative direct/transitive/cyclic outlives closure with converging-graph and long-chain stress, shared/mutable mode filtering, projection/scalar-holder/statically resolved ordinary-call/reordered-argument/acyclic-join provenance, all-candidate final-use liveness, construction-time aggregate rejection, generation-local memo/capacity reuse, malformed boundaries, and semantic/hover/definition plus snapshot/invalidation assertions for outlives-bound references. Remaining gaps include body-derived/general lexical inference, lifetime-bearing aggregate/shape/route/container storage, method/dynamic/callback/closure/extern/FFI forwarding, loop-carried fixed points, `'static`, and runtime ownership depth
