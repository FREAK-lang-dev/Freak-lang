...
| `lend value` / `lend mut value` expressions | ⚠️ | 📖 V4 — MIR lowers explicit borrow rvalues; Meiya tracks bound-local uses for rewrite/move conflicts and expires call-only lends at the call boundary |
