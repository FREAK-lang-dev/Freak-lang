...
define i64 @freak_add(i64 %arg_a, i64 %arg_b) {
entry:
    %a = alloca i64
    store i64 %arg_a, i64* %a
    %b = alloca i64
    store i64 %arg_b, i64* %b
    %t5110 = load i64, i64* %a
    %t5111 = load i64, i64* %b
    %t5112 = add i64 %t5110, %t5111
    ret i64 %t5112
    ret i64 0
}

define i64 @freak_multiply(i64 %arg_a, i64 %arg_b) {
entry:
    %a = alloca i64
    store i64 %arg_a, i64* %a
    %b = alloca i64
    store i64 %arg_b, i64* %b
    %t5113 = load i64, i64* %a
    %t5114 = load i64, i64* %b
    %t5115 = mul i64 %t5113, %t5114
    ret i64 %t5115
    ret i64 0
}

define void @freak_greet(i64 %arg_name) {
entry:
    %name = alloca i64
    store i64 %arg_name, i64* %name
    %t5116 = getelementptr inbounds [8 x i8], [8 x i8]* @.str.335, i64 0, i64 0
    %t5117 = ptrtoint i8* %t5116 to i64
    call void @freak_llvm_print_str(i64 %t5117)
    %t5118 = load i64, i64* %name
    call void @freak_llvm_print_str(i64 %t5118)
    %t5119 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.336, i64 0, i64 0
    %t5120 = ptrtoint i8* %t5119 to i64
    call void @freak_llvm_print_str(i64 %t5120)
    call void @freak_llvm_print_newline()
    ret void
}

define i64 @freak_is_even(i64 %arg_n) {
entry:
    %n = alloca i64
    store i64 %arg_n, i64* %n
    %t5121 = load i64, i64* %n
    %t5122 = srem i64 %t5121, 2
    %t5124 = icmp eq i64 %t5122, 0
    %t5123 = zext i1 %t5124 to i64
    ret i64 %t5123
    ret i64 0
}
...
entry:
    ...
    %t5125 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.337, i64 0, i64 0
    %t5126 = ptrtoint i8* %t5125 to i64
    store i64 %t5126, i64* @g_json_src
    store i64 0, i64* @g_json_pos
    ...
    %t5127 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.338, i64 0, i64 0
    %t5128 = ptrtoint i8* %t5127 to i64
    call void @freak_greet(i64 %t5128)
    %t5129 = call i64 @freak_add(i64 3, i64 4)
    %t5130 = call i64 @freak_llvm_word_from_int(i64 %t5129)
    call void @freak_llvm_say(i64 %t5130)
    %t5131 = call i64 @freak_multiply(i64 6, i64 7)
    %t5132 = call i64 @freak_llvm_word_from_int(i64 %t5131)
    call void @freak_llvm_say(i64 %t5132)
    %t5133 = call i64 @freak_is_even(i64 8)
    %t5137 = icmp ne i64 %t5133, 0
    br i1 %t5137, label %if.then.5134, label %if.end.5136
if.then.5134:
    %t5138 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.339, i64 0, i64 0
    %t5139 = ptrtoint i8* %t5138 to i64
    call void @freak_llvm_say(i64 %t5139)
    br label %if.end.5136
if.end.5136:
    %t5140 = call i64 @freak_is_even(i64 9)
    %t5142 = icmp eq i64 %t5140, 0
    %t5141 = zext i1 %t5142 to i64
    %t5146 = icmp ne i64 %t5141, 0
    br i1 %t5146, label %if.then.5143, label %if.end.5145
if.then.5143:
    %t5147 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.340, i64 0, i64 0
...
@.str.335 = private unnamed_addr constant [8 x i8] c"Hello, \00", align 1
@.str.336 = private unnamed_addr constant [2 x i8] c"!\00", align 1
@.str.337 = private unnamed_addr constant [1 x i8] c"\00", align 1
@.str.338 = private unnamed_addr constant [7 x i8] c"Takeru\00", align 1
@.str.339 = private unnamed_addr constant [5 x i8] c"even\00", align 1
@.str.340 = private unnamed_addr constant [4 x i8] c"odd\00", align 1
