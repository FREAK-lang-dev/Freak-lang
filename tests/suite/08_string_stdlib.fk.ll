...
@g_parts = global i64 0
@g_joined = global i64 0
...
entry:
    ...
    %t5112 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.336, i64 0, i64 0
    %t5113 = ptrtoint i8* %t5112 to i64
    %t5114 = call i64 @freak_string_repeat(i64 %t5113, i64 3)
    call void @freak_llvm_say(i64 %t5114)
    %t5115 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.337, i64 0, i64 0
    %t5116 = ptrtoint i8* %t5115 to i64
    %t5117 = call i64 @freak_string_reverse(i64 %t5116)
    call void @freak_llvm_say(i64 %t5117)
    %t5118 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.338, i64 0, i64 0
    %t5119 = ptrtoint i8* %t5118 to i64
    %t5120 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.339, i64 0, i64 0
    %t5121 = ptrtoint i8* %t5120 to i64
    %t5122 = call i64 @freak_string_count(i64 %t5119, i64 %t5121)
    %t5123 = call i64 @freak_llvm_word_from_int(i64 %t5122)
    call void @freak_llvm_say(i64 %t5123)
    %t5124 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.340, i64 0, i64 0
    %t5125 = ptrtoint i8* %t5124 to i64
    %t5126 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.341, i64 0, i64 0
    %t5127 = ptrtoint i8* %t5126 to i64
    %t5128 = call i64 @freak_string_pad_left(i64 %t5125, i64 6, i64 %t5127)
    call void @freak_llvm_say(i64 %t5128)
    %t5129 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.342, i64 0, i64 0
    %t5130 = ptrtoint i8* %t5129 to i64
    %t5131 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.343, i64 0, i64 0
    %t5132 = ptrtoint i8* %t5131 to i64
    %t5133 = call i64 @freak_string_pad_right(i64 %t5130, i64 5, i64 %t5132)
    call void @freak_llvm_say(i64 %t5133)
    %t5134 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.344, i64 0, i64 0
    %t5135 = ptrtoint i8* %t5134 to i64
    %t5136 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.345, i64 0, i64 0
    %t5137 = ptrtoint i8* %t5136 to i64
    %t5138 = call i64 @freak_string_split(i64 %t5135, i64 %t5137)
    store i64 %t5138, i64* @g_parts
    %t5139 = load i64, i64* @g_parts
    call void @freak_llvm_say(i64 %t5139)
    %t5140 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.346, i64 0, i64 0
    %t5141 = ptrtoint i8* %t5140 to i64
    %t5142 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.347, i64 0, i64 0
    %t5143 = ptrtoint i8* %t5142 to i64
    %t5144 = call i64 @freak_string_join(i64 %t5141, i64 %t5143)
    store i64 %t5144, i64* @g_joined
    %t5145 = load i64, i64* @g_joined
    call void @freak_llvm_say(i64 %t5145)
    ret void
}
...
@.str.336 = private unnamed_addr constant [3 x i8] c"ha\00", align 1
@.str.337 = private unnamed_addr constant [6 x i8] c"FREAK\00", align 1
@.str.338 = private unnamed_addr constant [7 x i8] c"banana\00", align 1
@.str.339 = private unnamed_addr constant [3 x i8] c"an\00", align 1
@.str.340 = private unnamed_addr constant [3 x i8] c"42\00", align 1
@.str.341 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.342 = private unnamed_addr constant [3 x i8] c"hi\00", align 1
@.str.343 = private unnamed_addr constant [2 x i8] c".\00", align 1
@.str.344 = private unnamed_addr constant [14 x i8] c"one,two,three\00", align 1
@.str.345 = private unnamed_addr constant [2 x i8] c",\00", align 1
@.str.346 = private unnamed_addr constant [6 x i8] c"a|b|c\00", align 1
