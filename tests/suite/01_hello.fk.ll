...
entry:
    ...
    %t5112 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.336, i64 0, i64 0
    %t5113 = ptrtoint i8* %t5112 to i64
    call void @freak_llvm_say(i64 %t5113)
    %t5114 = getelementptr inbounds [27 x i8], [27 x i8]* @.str.337, i64 0, i64 0
...
@.str.337 = private unnamed_addr constant [27 x i8] c"Self-hosting compiler: YES\00", align 1
