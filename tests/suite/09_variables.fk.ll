...
entry:
    ...
    store i64 42, i64* @g_x
    %t5111 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.336, i64 0, i64 0
    %t5112 = ptrtoint i8* %t5111 to i64
    store i64 %t5112, i64* @g_name
    store i64 1, i64* @g_flag
    %t5113 = load i64, i64* @g_x
    %t5114 = call i64 @freak_llvm_word_from_int(i64 %t5113)
    call void @freak_llvm_say(i64 %t5114)
    %t5115 = load i64, i64* @g_name
    call void @freak_llvm_say(i64 %t5115)
    %t5116 = load i64, i64* @g_flag
    %t5120 = icmp ne i64 %t5116, 0
    br i1 %t5120, label %if.then.5117, label %if.end.5119
if.then.5117:
    %t5121 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.337, i64 0, i64 0
    %t5122 = ptrtoint i8* %t5121 to i64
    call void @freak_llvm_say(i64 %t5122)
    br label %if.end.5119
if.end.5119:
    store i64 100, i64* @g_x
    %t5123 = load i64, i64* @g_x
    %t5124 = call i64 @freak_llvm_word_from_int(i64 %t5123)
    call void @freak_llvm_say(i64 %t5124)
    %t5125 = load i64, i64* @g_x
    %t5126 = add i64 %t5125, 5
    store i64 %t5126, i64* @g_x
    %t5127 = load i64, i64* @g_x
    %t5128 = call i64 @freak_llvm_word_from_int(i64 %t5127)
    call void @freak_llvm_say(i64 %t5128)
    %t5129 = load i64, i64* @g_x
    %t5130 = sub i64 %t5129, 10
    store i64 %t5130, i64* @g_x
    %t5131 = load i64, i64* @g_x
    %t5132 = call i64 @freak_llvm_word_from_int(i64 %t5131)
    call void @freak_llvm_say(i64 %t5132)
    %t5133 = load i64, i64* @g_x
    %t5134 = mul i64 %t5133, 2
    store i64 %t5134, i64* @g_x
    %t5135 = load i64, i64* @g_x
    %t5136 = call i64 @freak_llvm_word_from_int(i64 %t5135)
    call void @freak_llvm_say(i64 %t5136)
    ret void
}
...
@.str.336 = private unnamed_addr constant [4 x i8] c"Yui\00", align 1
@.str.337 = private unnamed_addr constant [5 x i8] c"true\00", align 1
