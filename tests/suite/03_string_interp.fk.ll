...
@g_name = global i64 0
@g_version = global i64 0
@g_greeting = global i64 0
...
entry:
    ...
    %t5112 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.336, i64 0, i64 0
    %t5113 = ptrtoint i8* %t5112 to i64
    store i64 %t5113, i64* @g_name
    store i64 13, i64* @g_version
    %t5114 = getelementptr inbounds [8 x i8], [8 x i8]* @.str.337, i64 0, i64 0
    %t5115 = ptrtoint i8* %t5114 to i64
    call void @freak_llvm_print_str(i64 %t5115)
    %t5116 = load i64, i64* @g_name
    call void @freak_llvm_print_str(i64 %t5116)
    %t5117 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.338, i64 0, i64 0
    %t5118 = ptrtoint i8* %t5117 to i64
    call void @freak_llvm_print_str(i64 %t5118)
    call void @freak_llvm_print_newline()
    %t5119 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.339, i64 0, i64 0
    %t5120 = ptrtoint i8* %t5119 to i64
    call void @freak_llvm_print_str(i64 %t5120)
    %t5121 = load i64, i64* @g_version
    call void @freak_llvm_print_int(i64 %t5121)
    call void @freak_llvm_print_newline()
    %t5122 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.340, i64 0, i64 0
    %t5123 = ptrtoint i8* %t5122 to i64
    %t5124 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.341, i64 0, i64 0
    %t5125 = ptrtoint i8* %t5124 to i64
    %t5126 = call i64 @freak_llvm_word_concat(i64 %t5123, i64 %t5125)
    %t5127 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.342, i64 0, i64 0
    %t5128 = ptrtoint i8* %t5127 to i64
    %t5129 = call i64 @freak_llvm_word_concat(i64 %t5126, i64 %t5128)
    store i64 %t5129, i64* @g_greeting
    %t5130 = load i64, i64* @g_greeting
...
@.str.336 = private unnamed_addr constant [9 x i8] c"Shiranui\00", align 1
@.str.337 = private unnamed_addr constant [8 x i8] c"Hello, \00", align 1
@.str.338 = private unnamed_addr constant [2 x i8] c"!\00", align 1
@.str.339 = private unnamed_addr constant [10 x i8] c"Version: \00", align 1
@.str.340 = private unnamed_addr constant [6 x i8] c"Hello\00", align 1
@.str.341 = private unnamed_addr constant [3 x i8] c", \00", align 1
@.str.342 = private unnamed_addr constant [7 x i8] c"world!\00", align 1
