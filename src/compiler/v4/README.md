...
tuple/list/repeat-fill inference and declared-initializer mismatch diagnostics,
fixed-array compile-time lengths with root-constant integer arithmetic, generic
doctrine bounds plus multi-bound method/editor enforcement, and named
