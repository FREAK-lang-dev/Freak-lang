...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            ...
            "health-diff|",
            "unit-diagnostics-section-validation=diagnostics-snapshot-import ok=1 format=freak-diagnostics-snapshot-v1 lines=2 sets=0 diagnostics=0 malformed=0 headers=1 ends=1",
            "unit-diagnostics-changed-section-validation=diagnostics-snapshot-import ok=1 format=freak-diagnostics-snapshot-v1 lines=2 sets=0 diagnostics=0 malformed=0 headers=1 ends=1",
            "unit-section|diagnostics|diagnostics-snapshot%7Cformat=freak-diagnostics-snapshot-v1%7Csets=2%7Cdiagnostics=1",
            "diagnostic%7C0%7C0%7C2%257C0@67:76%257Cinvalid binary operation%257C- between word and int",
            "00-unit-manifest|format=freak-00-unit-manifest-v1|ok=1|payload-format=freak-00-unit-snapshot-v1|payload-bytes=25456|payload-lines=17|sources=1|declared-sources=1|sections=14|declared-sections=14",
            "section|diagnostics|bytes=257|lines=5|records=5|ok=1|validation=diagnostics-snapshot-import ok=1 format=freak-diagnostics-snapshot-v1 lines=5 sets=2 diagnostics=1 malformed=0 headers=1 ends=1",
            "00-unit-health|format=freak-00-unit-health-v1|ok=1|snapshot-ok=1|snapshot-bytes=25420|manifest-bytes=3138|manifest-lines=17|sources=1|sections-ok=14|sections-bad=0|query-entries=24|query-dirty=15|query-invalidations=15|query-hits=59|query-misses=29|query-stores=24",
            "health-section|name=diagnostics|ok=1|bytes=257|records=5|validation=diagnostics-snapshot-import ok=1 format=freak-diagnostics-snapshot-v1 lines=5 sets=2 diagnostics=1 malformed=0 headers=1 ends=1",
    ...
    },
    {
        ...
        "expect": [
            ...
            "semantic-core-route-kind=Route",
            "semantic-core-route-type=route Event",
            ...
            "semantic-core-symbol0-kind=Route",
            "semantic-core-symbol0-type=route Event",
            "semantic-core-symbol1-name=Event::Key",
            "semantic-core-symbol1-kind=RouteCase",
            "semantic-core-symbol1-type=route case Event::Key { code: int }",
    ...
    },
    {
        ...
        "expect": [
            ...
            "route-case-decl-type=route case Event::Key { code: int, repeat: bool }",
            "route-case-ctor-kind=RouteCase",
            "route-case-ctor-type=route case Event::Key { code: int, repeat: bool }",
            "route-case-when-name=Key",
            "route-case-when-kind=RouteCase",
            "route-case-when-type=route case Event::Key { code: int, repeat: bool }",
            "route-case-hover-name=Key",
            "route-case-hover-kind=RouteCase",
            "route-case-hover-type=route case Event::Key { code: int, repeat: bool }",
            ...
            "route-case-symbol0-kind=Route",
            "route-case-symbol1-name=Event::Key",
            "route-case-symbol1-kind=RouteCase",
            "route-case-symbol1-type=route case Event::Key { code: int, repeat: bool }",
            "route-case-symbol2-name=Event::Closed",
            "route-case-symbol2-kind=RouteCase",
            "route-case-symbol2-type=route case Event::Closed",
            "route-case-completion-count=21",
            "route-case-completion-key-found=true",
            "route-case-completion-key-detail=route case Event::Key { code: int, repeat: bool }",
            "route-case-completion-closed-found=true",
            "route-case-completion-closed-detail=route case Event::Closed",
        ],
    },
    {
        ...
        "expect": [
            ...
            "route-field-decl-type=route field Event::Key.code: int",
            "route-field-ctor-kind=RouteField",
            "route-field-ctor-type=route field Event::Key.code: int",
            "route-field-repeat-kind=RouteField",
            "route-field-repeat-type=route field Event::Key.repeat: bool",
            "route-field-hover-name=repeat",
            "route-field-hover-kind=RouteField",
            "route-field-hover-type=route field Event::Key.repeat: bool",
            ...
            "route-field-completion-code-detail=route field Event::Key.code: int",
            "route-field-completion-repeat-found=true",
            "route-field-completion-repeat-kind=route-field",
            "route-field-completion-repeat-detail=route field Event::Key.repeat: bool",
        ],
    },
    {
        ...
        "expect": [
            ...
            "check-route-editor-key-type=route case Event::Key { code: int, repeat: bool }",
            "check-route-editor-repeat-kind=RouteField",
            "check-route-editor-repeat-type=route field Event::Key.repeat: bool",
            ...
            "check-route-editor-closed-detail=route case Event::Closed",
        ],
    },
    {
        ...
        "expect": [
            ...
            "only-on-editor-key-type=route case Event::Key { code: int, repeat: bool }",
