...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            ...
            "route-payload-arm0-lhs=event == Key",
            "route-payload-arm0-rvalue-kind=Binary",
            "route-payload-arm0-rvalue-op=Eq",
            "route-payload-arm0-rvalue-ty=bool",
            "route-payload-arm1-kind=Branch",
            "route-payload-arm1-lhs=event == Event::Key and event.code == 9",
            "route-payload-arm1-rvalue-kind=Binary",
            "route-payload-arm1-rvalue-op=And",
            "route-payload-arm1-rvalue-ty=bool",
            "route-payload-arm1-left-kind=Binary",
            "route-payload-arm1-left-text=event == Event::Key",
            "route-payload-arm1-left-ty=bool",
            "route-payload-arm1-right-kind=Binary",
            "route-payload-arm1-right-text=event.code == 9",
            "route-payload-arm1-right-ty=bool",
