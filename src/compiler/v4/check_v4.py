...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            ...
            "copy-doctrine-parse-cache-primed=true",
            "copy-doctrine-parse-restore-ok=true",
            "copy-doctrine-parse-generation-advanced=true",
            "copy-doctrine-parse-ty-cache-reset=true",
            "copy-doctrine-parse-borrow-cache-reset=true",
            "copy-doctrine-parse-restore-cache-reset=true",
            "copy-doctrine-hir-cache-primed=true",
            "copy-doctrine-hir-restore-ok=true",
            "copy-doctrine-hir-generation-advanced=true",
            "copy-doctrine-hir-ty-cache-reset=true",
            "copy-doctrine-hir-borrow-cache-reset=true",
            "copy-doctrine-hir-restore-cache-reset=true",
        ],
    },
    {
    ...
    },
    {
        ...
        "expect": [
            ...
            "projected-closure-borrow-diagnostics=7",
            "projected-closure-use-storage-rejected=blocked",
            "projected-closure-overwrite-storage-clean=clean",
            "projected-closure-zero-length-call-clean=clean",
            "projected-closure-nested-zero-length-call-clean=clean",
            "projected-closure-dynamic-call-storage-rejected=blocked",
