...
CRATE_BOUNDARY_REQUIRED = {
    ...
    "freak_hir": [
        ("expansion dependency", "-- Depends on freak_span, freak_diag, and freak_expand."),
...
UNIT_SNAPSHOT_SECTIONS = [
    ...
    {
        "name": "expand",
        "validate": "v4_expand_snapshot_validate(section_payload)",
        "restore": "v4_expand_snapshot_restore(section_payload)",
        "endpoint": "workspace/expandSnapshotRestore",
    },
    {
        "name": "hir",
...
INVALIDATION_FAMILY_FIELDS = [
    ...
    ("expand", "expand-invalidations-added"),
...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            ...
            "00-unit-snapshot-restore ok=1 sources=1 sections=15 confirmed-sources=1",
            "ok|workspace/unitSnapshotRestore",
    ...
    },
    {
        ...
        "expect": [
            ...
            "sources-changed=1",
            "query-invalidations-added=10",
            "diagnostics-invalidations-added=1",
            "ok|workspace/unitSnapshotHealth",
            "health-diff|ok=1|sources-added=0|sources-changed=1|sources-removed=0|sections-added=0|sections-changed=10|sections-removed=0|query-invalidations-added=10",
    ...
    },
    {
        ...
        "expect": [
            ...
            "keyword-case-row-1=Task|ident|Task",
            "keyword-case-row-2=TASK|ident|TASK",
            "keyword-case-row-3=TaSk|ident|TaSk",
            "keyword-case-row-4=shape|keyword|shape",
            "keyword-case-row-5=ShApE|ident|ShApE",
            "keyword-case-row-6=pilot|keyword|pilot",
            "keyword-case-row-7=Pilot|ident|Pilot",
            "keyword-case-row-8=some|keyword|some",
            "keyword-case-row-9=Some|ident|Some",
            "keyword-case-row-10=SOME|ident|SOME",
            "keyword-case-row-11=NAKAMA|keyword|NAKAMA",
            "keyword-case-row-12=Nakama|ident|Nakama",
            "keyword-case-row-13=nakama|ident|nakama",
            "keyword-case-row-14=TSUNDERE|keyword|TSUNDERE",
            "keyword-case-row-15=Tsundere|ident|Tsundere",
            "keyword-case-row-16=tsundere|ident|tsundere",
            "keyword-case-row-17=taskforce|ident|taskforce",
            "keyword-case-row-18=Task2|ident|Task2",
            "keyword-case-row-19=pilotTask|ident|pilotTask",
            "keyword-case-rows=20",
            "keyword-case-mismatches=0",
            "keyword-case-snapshot=token|0|0|keyword|task|0@0:4|1|1",
            "keyword-case-identifier-snapshot=token|7|0|ident|Pilot|7@0:5|1|1",
            "keyword-case-parse-diagnostics=0",
            "keyword-case-parse-tasks=1",
            "keyword-case-parse-lower=lower",
            "keyword-case-reject-token-type=ident",
            "keyword-case-reject-token-value=Task",
            "keyword-case-reject-diagnostics=1",
            "keyword-case-reject-message=unexpected token at top level",
            "keyword-case-reject-help=Task",
            "keyword-case-reject-snapshot=parse-diag|1|0|2%7C101@0:21%7Cunexpected token at top level%7CTask",
        ],
    },
    {
        "name": "parse baseline",
    ...
    {
        "name": "expand identity flow",
        "fixture": "expand_identity_smoke.fk",
        "expect_exact": [
    ...
    {
        "name": "expand invalidation snapshot contract",
        "fixture": "expand_invalidation_snapshot_smoke.fk",
        "memory_limit_mb": 128,
        "expect_exact": [
            "expand-query-dependency=true",
            "expand-invalidation-count=1",
            "expand-parse-invalidation-count=1",
            "expand-lex-invalidation-count=1",
            "expand-snapshot-validation=true",
            "expand-lsp-snapshot=true",
            "expand-unit-section=true",
            "expand-unit-manifest=true",
    ...
    },
    {
        ...
        "expect": [
            ...
            "hir-scaling-source-garbage=true",
            "hir-scaling-source-negative=true",
            "hir-scaling-source-noncanonical=true",
            "hir-scaling-source-overflow=true",
            "hir-scaling-expansion-garbage=true",
            "hir-scaling-expansion-negative=true",
            "hir-scaling-expansion-noncanonical=true",
            "hir-scaling-expansion-overflow=true",
            "hir-scaling-childless-owner-identities=true",
            "hir-scaling-canonical-parent-identity=true",
            ...
            "hir-scaling-index-exhaustion-validation=true",
    ...
    },
    {
        ...
        "expect": [
            ...
            "query-snapshot-restore ok=1 generation=2 entries=20 edges=75 dirty=20 cache=20 deps=75 skipped-generations=1 skipped-invalidations=0 skipped-telemetry=20 skipped-other=0",
            "query-confirm ok=1 path=named-lifetime-editor.fk generation=3 considered=20 matched=20 promoted=20 blocked=0 already-valid=0 dirty-nonrestored=0 mismatched=0 dirty=0",
    ...
    {
        "name": "contract region body derived probe",
        "fixture": "contract_region_body_derived_probe_smoke.fk",
        "timeout": 90,
        "memory_limit_mb": 96,
        "expect_mode": "line",
        "expect_unique": True,
...
def check_snapshot_inventories() -> None:
    ...
    linear_snapshot_sources = {
        ...
        "expand": read_text(crate_path("freak_expand")),
