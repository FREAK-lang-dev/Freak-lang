...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            ...
            "contract-region-relation-stress-repetitions=8",
            "contract-region-relation-stress-scratch-active=4",
            "contract-region-relation-stress-scratch-capacity=48",
            "contract-region-relation-stress-scratch-generation-delta=40",
