    ...
    },
    {
        ...
        "expect": [
           ...
           "contract-region-generic-lend-escape-diag1-help=identity infers T as lend Ship; keep lends on explicit lend parameters and outer borrowed returns until generic provenance exists",
            ...
            "contract-region-owner-generic-negative-diag4-help=Box<Direct<'a>>::pack derives owner generic T as Direct<'a>; keep lends on explicit lend parameters and outer borrowed returns until generic provenance exists",
            "contract-region-owner-generic-negative-diag5-message=Meiya cannot substitute a lend-bearing type for a generic call yet",
            "contract-region-owner-generic-negative-diag5-help=Box<Direct<'a>>.keep derives owner generic T as Direct<'a>; keep lends on explicit lend parameters and outer borrowed returns until generic provenance exists",
            "contract-region-owner-generic-negative-diag6-message=Meiya cannot substitute a lend-bearing type for a generic call yet",
            "contract-region-owner-generic-negative-diag6-help=Shared<Direct<'a>>::new derives owner generic T as Direct<'a>; keep lends on explicit lend parameters and outer borrowed returns until generic provenance exists",
