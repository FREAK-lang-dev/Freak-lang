...
EXECUTABLE_SMOKES = [
    ...
    },
    {
        ...
        "expect": [
            "codegen-llvm declarations=5 calls=4 diagnostics=0",
            ...
            "codegen-llvm-call-puts-line=call ccc i64 @puts",
            "codegen-llvm-call-win-abi=stdcall",
            "codegen-llvm-call-win-cc=x86_stdcallcc",
            "codegen-llvm-call-win-line=call x86_stdcallcc i64 @win_tick",
            "codegen-llvm-call-host-abi=system",
            "codegen-llvm-call-host-cc=ccc",
            "codegen-llvm-call-host-line=call ccc i64 @host_tick",
            "codegen-llvm-call-double-symbol=@util_math_double",
            "codegen-llvm-call-double-line=call ccc i64 @util_math_double",
        ],
    },
    {
