...
| §1.15 Literals | ⚠️ Partial — fixed-array `[T;N]` literals, repeat-fill `[0; 100]`, numeric suffixes, and integer root-constant arithmetic for array lengths work in V4; full const-expression evaluation remains 🔜 V4 |
