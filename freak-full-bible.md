...
| §1.15 Literals | ⚠️ Partial — fixed-array `[T;N]` literals, repeat-fill `[0; 100]`, numeric suffixes, integer root-constant arithmetic for array lengths, and root-const tuple/list/repeat-fill type inference with declared-initializer diagnostics work in V4; full const-expression evaluation remains 🔜 V4 |
