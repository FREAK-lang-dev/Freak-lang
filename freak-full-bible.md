...
> Multi-block bodies suppress a final drop only when every reachable CFG exit
> has moved the local without reinitializing it. Conditional runtime drop flags
> for one-branch moves remain future Meiya work.
