...
The next active goal should continue Goal E by packaging the evaluator in the browser asset manifest once it covers enough of the basics course to be useful on `freaklang.dev`.
