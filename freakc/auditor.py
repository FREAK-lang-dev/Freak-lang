...
def audit_conformance(paths: List[Path]) -> int:
    ...
    required_harness_expects = {
        ...
        "contract_region_fixed_aggregate_smoke.fk": (
            ...
            "fixed-aggregate-borrow-diagnostics=46",
            ...
            "fixed-aggregate-repeat-shared-partial-rebind-1025=clean",
            "fixed-aggregate-repeat-shared-extracted-alias-rebind-256=blocked",
