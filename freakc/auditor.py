    ...
    contract_region_docs = (
        (
            ...
            (
                ...
                "per-memo adjacency lists",
                "4,096 memo entries",
                "65,536 work items",
                "solved-memo frontier",
                "256-root smoke",
                "Per-borrow round/limit/solve/convergence/resource/work telemetry",
                "snapshot v2 restore",
        ...
        (
            ...
            (
                ...
                "aggregate task parameters and returns",
                ...
                "telemetry is keyed per\nborrowck result",
                "v2 borrowck snapshot",
                "Legacy v1 imports",
                "truncated v2 telemetry records fail validation",
                "solved-memo frontier",
                "256 independent roots",
                "backedge-only edit",
                "remain open",
            ),
        ),
        (
            ...
            (
                ...
                "aggregate task boundaries",
                "backend lowering remain future Meiya work",
                "bounded ring",
                "append-only compiler",
                "iterative worklist",
                "reverse dependency edge",
                "per-memo adjacency list",
                "4,096 memo",
                "65,536 processed work items",
                "solved-memo frontier",
                "Generation-stamped per-body memo chains",
                "telemetry is keyed by borrowck result",
                "borrowck snapshot v2",
                "Legacy v1 snapshots remain importable",
                "v2 record missing any telemetry field fails validation",
                "64-diamond fixture",
                "Loop-carried provenance fixed points are implemented",
        ...
        (
            ...
            (
                ...
                "solved-memo frontier",
                "Generation-stamped per-body memo chains",
                "256-root solver smoke",
                "keyed by borrowck\nresult",
                "borrowck snapshot v2",
                "Legacy v1 snapshots remain importable",
                "truncated v2 telemetry records are rejected",
                "64-diamond CFG\nsmoke",
                "byte-length-stable loop-backedge edit",
    ...
    contract_region_smoke_needles = (
        ...
        (
            ...
            (
                ...
                "contract-region-storage-mir-diagnostics-exact-fifteen=",
                ...
                "contract-region-storage-borrow-diagnostics-exact-fifteen=",
