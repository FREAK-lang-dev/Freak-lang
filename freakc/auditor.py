...
def audit_conformance(paths: List[Path]) -> int:
    ...
    contract_region_docs = (
        (
            ...
            (
                ...
                "three aggregate\n> totals",
                "Scalar and fixed-layout lends may cross ordinary",
                "TY flattens every supported parameter and return",
                "same-lifetime siblings are conservative",
                "MIR maps each returned leaf",
                "Call-result aliases preserve",
                "Fixed-array boundaries use `[*]`",
                "source-less aggregate return leaves",
                "Fixed-layout local and task-boundary facts",
                "non-ordinary aggregate\n> boundaries",
                "runtime\n> aggregate-loan ABI",
                "bounded rings",
                "iterative\n> memo worklist",
        ...
        (
            ...
            (
                ...
                "ordinary static task boundaries",
                "deterministic projection, mode, lifetime, and optional route guard",
                "same-lifetime siblings",
                "MIR maps return leaves",
                "Meiya\nseeds aggregate parameter provenance",
                "tuple and shape projections",
                "Fixed-array task\nboundaries use `[*]`",
                "Source-less signatures and callee-owned aggregate escapes",
                "all 17 invalidation\nfields",
                "00-Unit diff",
                "no aggregate-only LSP method or snapshot section",
                "non-ordinary aggregate forwarding",
        ...
        (
            ...
            "\n### Why MIR is Required",
            (
                "Declared lifetime graph and fixed-layout leaf contracts",
                "Return-leaf to call-argument-leaf mappings",
                "Every returned leaf must have at least one compatible source leaf",
                "same-lifetime siblings fail conservative",
                "fixed-array task boundaries use `[*]`",
                "Meiya seeds fixed-layout parameter leaves",
                "Source-less signatures and callee-owned escapes",
                "Call aliases retain return projections",
                "all 17 invalidation fields",
                "00-Unit diff",
                "No aggregate-only protocol exists",
                "These facts use existing tooling protocols",
                "non-ordinary aggregate boundaries",
        ...
        (
            ...
            (
                ...
                "ordinary static task parameters and returns",
                "deterministic leaf contracts",
                "same-lifetime sibling",
                "signature metadata, not caller ownership",
                "source-less aggregate return",
                "Call-result aliases retain",
                "Fixed arrays intentionally use `[*]`",
                "unrelated tuple and shape",
                "Fixed-layout local and task-boundary editor facts",
                "existing query families and 00-Unit",
                "no aggregate-specific LSP endpoint",
                "runtime aggregate-loan ABI",
                "bounded rings",
    ...
    if v4_borrowck_lib_return.exists():
        ...
        for needle in (
            ...
            "pilot has_local_holder = v4_borrowck_place_is_local_storage_projection(",
    ...
    contract_region_smoke_needles = (
        ...
        (
            ...
            (
                ...
                "contract-region-loop-query-all-17-invalidations-positive=",
                "contract-region-loop-query-invalidation-matches-diff=",
                "contract-region-loop-query-signature-stable=",
                "contract-region-loop-query-all-17-recomputations-positive=",
        ...
        (
            ...
            (
                ...
                "say \"aggregate-boundary-diag\" + word_from_int",
            ),
        ),
        (
        ...
        (
            ...
            (
                ...
                "task pass<'a,'b>(view: Pair<lend mut 'a Ship,lend mut 'b Ship>)",
                "v4_fixed_aggregate_query_call_facts(",
                "task v4_fixed_aggregate_query_run()",
                "v4_fixed_aggregate_query_all_recomputed(",
                "v4_fixed_aggregate_query_find_symbol(",
                '"seed.left"',
                '"seed.rght"',
                ...
                "v4_unit_snapshot_health_append_diff(",
                "v4_unit_snapshot_restore(",
                "fixed-aggregate-query-all-17-invalidations-positive=",
                "fixed-aggregate-query-invalidation-matches-diff=",
                "fixed-aggregate-query-after-shape-facts=",
                "fixed-aggregate-query-before-call-facts=",
                "fixed-aggregate-query-after-call-facts=",
                "fixed-aggregate-query-after-semantic-type=",
                "fixed-aggregate-query-after-hover-type=",
                "fixed-aggregate-query-after-definition-name=",
                "fixed-aggregate-query-after-document-symbol-observe=",
                "fixed-aggregate-query-all-17-recomputations-positive=",
                "fixed-aggregate-query-restored-call-facts=",
        ...
        (
            ...
            (
                ...
                "contract-region-query-all-17-invalidations-positive=",
                ...
                "contract-region-query-all-17-recomputations-positive=",
        ...
        (
            ...
            (
                ...
                "contract-region-elided-query-all-17-invalidations-positive=",
                ...
                "contract-region-elided-query-all-17-recomputations-positive=",
    ...
    required_harness_expects = {
        ...
        "contract_region_aggregate_boundary_smoke.fk": (
            "aggregate-boundary-parse-diagnostics=0",
            "aggregate-boundary-ty-diagnostics=1",
            "aggregate-boundary-mir-diagnostics=2",
            "aggregate-boundary-borrow-diagnostics=12",
            ...
            "aggregate-boundary-ty-diag0=Meiya cannot find a source for returned lifetime 'a at .0",
            "aggregate-boundary-ty-diag0-help=add a compatible lend parameter leaf whose declared lifetime outlives this returned projection",
        ...
        "contract_region_aggregate_edge_smoke.fk": (
            ...
            "aggregate-edge-mir-diagnostics=1",
            "aggregate-edge-borrow-diagnostics=4",
        ...
        "contract_region_fixed_aggregate_smoke.fk": (
            ...
            "fixed-aggregate-borrow-diagnostics=43",
            ...
            "fixed-aggregate-repeat-copy-diagnostic-count=3",
            ...
            "fixed-aggregate-repeat-shared-rebind-257=clean",
            ...
            "fixed-aggregate-dynamic-closure-storage-diagnostic-count=7",
            "fixed-aggregate-fixed-closure-storage-diagnostic-count=4",
        ...
        "contract_region_fixed_aggregate_query_smoke.fk": (
            ...
            "fixed-aggregate-query-before-call-facts=true",
            "fixed-aggregate-query-before-editor-coherent=true",
            "fixed-aggregate-query-before-semantic-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-before-hover-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-before-definition-name=views",
            "fixed-aggregate-query-before-definition-kind=Local",
            "fixed-aggregate-query-before-completion-views=true",
            "fixed-aggregate-query-before-document-symbol-observe=true",
            ...
            "fixed-aggregate-query-after-call-facts=true",
            "fixed-aggregate-query-after-editor-coherent=true",
            "fixed-aggregate-query-after-semantic-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-after-hover-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-after-definition-name=views",
            "fixed-aggregate-query-after-definition-kind=Local",
            "fixed-aggregate-query-after-completion-views=true",
            "fixed-aggregate-query-after-document-symbol-observe=true",
            "fixed-aggregate-query-all-17-recomputations-positive=true",
            ...
            "fixed-aggregate-query-restored-call-facts=true",
            "fixed-aggregate-query-restored-editor-coherent=true",
            "fixed-aggregate-query-restored-semantic-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-restored-hover-type=Pair<lend mut 'a Ship,lend mut 'b Ship>",
            "fixed-aggregate-query-restored-definition-name=views",
            "fixed-aggregate-query-restored-definition-kind=Local",
            "fixed-aggregate-query-restored-completion-views=true",
            "fixed-aggregate-query-restored-document-symbol-observe=true",
        ),
