...
def audit_conformance(paths: List[Path]) -> int:
    ...
    if v4_ty_lib_return.exists():
        ...
        for needle in (
            ...
            "task v4_ty_signature_source_can_project_target(",
    ...
    contract_region_smoke_needles = (
        ...
        (
            ...
            (
                "shape Node<'a>",
                "next: List<Node<'a>>",
                "task recursive_pass<'a>(node: Node<'a>)",
                "recursive-wrapper-storage-class=",
                "recursive-wrapper-fixed-storage=",
                "recursive-wrapper-leaf-count=",
    ...
    required_harness_expects = {
        ...
        "contract_region_aggregate_boundary_smoke.fk": (
            ...
            "aggregate-boundary-core-mir-diagnostics=1",
            "aggregate-boundary-core-borrow-diagnostics=8",
